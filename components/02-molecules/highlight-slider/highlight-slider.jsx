...
const HighlightSlider = () => {
    ...
    const playSlide = () => {
        gsap.context(() => {
            const boxes = gsap.utils.toArray('.box .progress__status');
            ...
            timeline.current.to(boxes, { right: '100%', left: '0%', duration: 0, ease: 'inOut' }, '-0');
            ...
            timeline.current.to(boxes[counter], { right: '0%', duration: 2, ease: 'none' });
            timeline.current.to(boxes[counter], { left: '100%', duration: 2, ease: 'none ' });
